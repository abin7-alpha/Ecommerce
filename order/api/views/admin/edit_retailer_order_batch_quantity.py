...
from order.functions import sendUpdatedOrderConfirmationMailToCustomer, upload_invoice_to_aws, send_updated_order_sms

from account.functions import stock_available_send_notification

@api_view(['POST',])
@permission_classes([AllowAny,])
def retailer_order_batch_quantity_edit_by_admin(request):
    output = {}
    data = request.data
